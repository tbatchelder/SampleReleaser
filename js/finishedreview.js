...
async function loadFileByDate() {
  ...
  const filename = `finished_entries_${selectedDate}.json`;
...
function approveBatch() {
  ...
  a.href = url;
  a.download = `APPROVED_Finished_Product_${currentReviewData.submittedBy}_${new Date().toISOString().split('T')[0]}.json`;
